---
name: fw-auto
description: Firmware workflow entry recommender. Use when the user asks what to do next in a firmware project, wants to continue a firmware workflow, gives a firmware request that must be routed to new project, feature iteration, refactor, debug/fix, verify, finish, handoff brief, or skill-system governance, or when a previous firmware skill returned a terminal status.
---
